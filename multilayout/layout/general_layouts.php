<?php
/* SELECT LAYOUT */               /* Comment out unnecessary lines leaving one layout choice active */
/*---------------*/               /* if no layout is selected then 3col_holygrail will be applied */
                                  /* if more than one layout is selected the active line in this list will determine the layout */
...
if (!isset($layout)) {$layout="3col_holygrail";}
